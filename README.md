...
[LIVE website here](https://cambboyle.github.io/PortfolioProject-1)
...
![Am I Responsive](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/AmIResponsive.png)
...
* [User Experience](#user-experience)
  ...
  * [Deployment](#deployment)
    ...
    + [Fork](#how-to-fork-this-project-to-github)
  * [Credits](#credits)
...
- As a returning visitor to the site:
  1. Navigate to the projects page to check for new projects.
  2. Navigate to the resume page to check for work updates.
  3. Navigate to the about me page to check for updated skills.
  4. Navigate to contact page in order to contact me for work.
...
* Navigation bar
  ...
  - Includes dropdown menu for projects section.
  - Changes colours depending on what page you're on to distinguish different pages.
  - Easy navigation between site pages.
  - Current page is highlighted with a brighter colour.
  - Hover effect adds a nice touch.
  
  ![Navbar](https://github.com/cambboyle/PortfolioProject-1/assets/38697428/c9b88a90-0ff3-4f8b-b20b-770196590f36)
  ![Navbar-dropdown](https://github.com/cambboyle/PortfolioProject-1/assets/38697428/eb27a502-3e43-402e-b2e4-53f89ea7e2d5)

* Footer

  - Footer features a second navbar, in cases where content is a long scroll down.
  - Includes social links to my X/Twitter, LinkedIn, GitHub and Slack.

  ![FooterNav](https://github.com/cambboyle/PortfolioProject-1/assets/38697428/fbefb2ec-e192-4689-9f16-94e8ba928660)
 ...
 * More projects will be added the further my career goes on.
 * Update skills section with more languages/apps as I learn them.
 * Update work experience when I get there.
...
![Home Page Visual](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/HomePageFinal.png)
...
![About Me Visual](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/AboutMeFinal.png)
...
![Resume Page Visual](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/ResumeFinal.png)
...
![Projects Page](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/ProjectsFinal.jpg)
...
![Contact Page Visual](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/ContactFinal.png)
    
</details>

<details>
    <summary>Project One Page</summary>

![Project One Visual](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/Project1Final.png)
...
- Result:
  ...
  Images:
    ...
    <details>
        <summary>Home Page on Mobile</summary>

    ![Home page on Mobile](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/MobileHome.jpg)

    </details>

    <details>
        <summary>Contact Page on Mobile</summary>

     ![Contact page on Mobile](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/MobileContact.jpg)
    
    </details>

    <details>
        <summary>Projects Page on Mobile</summary>

    ![Projects page on Mobile](https://github.com/cambboyle/PortfolioProject-1/blob/main/assets/images/readme%20images/MobileProjects.jpg)
...
#### How to Fork this project to GitHub

1. Log in to GitHub
2. Follow this link to the [GitHub Repository](https://github.com/cambboyle/PortfolioProject-1
3. At the top of the Repository, locate the fork button.
4. It now should be forked as a copy on your own GitHub account.
